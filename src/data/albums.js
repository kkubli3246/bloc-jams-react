export default [{
  ...
  songs: [
    ...
    slug: 'the-telephone',
    songs: [
      { title: 'Blxue', duration: '161.71', audioSrc: '/assets/music/blue.mp3' },
      { title: 'Grexen', duration: '103.96', audioSrc: '/assets/music/green.mp3' },
      { title: 'Rxed', duration: '268.45', audioSrc: '/assets/music/red.mp3' },
      { title: 'Pixnk', duration: '153.14', audioSrc: '/assets/music/pink.mp3' },
      { title: 'Maxgenta', duration: '374.22', audioSrc: '/assets/music/magenta.mp3' }
    ]
}];
